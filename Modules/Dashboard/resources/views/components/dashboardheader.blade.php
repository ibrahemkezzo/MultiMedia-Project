              ...
              <div class="logo-wrapper">
                  <a href="index.html">
                      <img class="blur-up lazyloaded d-block d-lg-none"
                          src="{{ asset('modules/dashboard/images/dashboard/multikart-logo-black.png') }}" alt="">
                  </a>
              </div>
          </div>
              ...
              <ul class="nav-menus">
                  <li>
                      <form class="form-inline search-form">
                          <div class="form-group">
                              <input class="form-control-plaintext" type="search" placeholder="{{__('Search..')}}">
                  ...
                  <li class="onhover-dropdown">
                    ...
                    @endforeach --}}
                      ...
                      <ul class="language-dropdown onhover-show-div p-20">
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <li>
                                <a href="{{LaravelLocalization::getLocalizedURL($localeCode, null, [], true)}}" data-lng="{{$localeCode}}">
                  ...
                  <li>
                      <a href="javascript:void(0)">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                              fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                              stroke-linejoin="round" class="feather feather-message-square right_side_toggle">
                  ...
                  <li class="onhover-dropdown">
                      <div class="media align-items-center">
                          <img class="align-self-center pull-right img-40 blur-up lazyloaded"
                              src="{{ asset(Auth::user()->profile_photo_path ?? 'modules/dashboard/images/dashboard/profile.png') }}" alt="header-user">
                      ...
                      <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                          ...
                          <li>
                              ...
                              <!-- 2. بدون تأكيد (مباشر) -->
                                <x-dashboard::auth.logout-link class="d-flex align-items-center gap-2">
