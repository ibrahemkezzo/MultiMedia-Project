...
@section('breadcrumbs')
    <x-dashboard::dashboardbreadcrumb :breadcrumbs="[
        ...
        ['label' => $user->name, 'url' => route('dashboard.users.show',$user->id)]
        ]"
        :pageName="$user->name"
        :pageDsecript="__('Manage Users')"
    />
@endsection
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="profile-details text-center">
                            <img src="{{$user->profile_photo_url ? asset($user->profile_photo_url) : asset('modules/dashboard/images/dashboard/designer.jpg')}}" alt=""
